...
function agregarTarea(texto){
  ...
  /* cuando agrego la tarea actualizo el valor del string (se pisan)
  y lo guardo en la ubicacion de "tareas" en el localStorage
  setItem añade un valor y si existe lo actualiza
  */
  input.value="";
}
...
window.onload= function(){
  recuperarUbicacion();
  console.lon(geo); //me muestra la ubicacion
  /*la estructura deberia verse: pero debe ser vacio
  tareas =[
    {
      titulo: "tarea1"; completado: false; ubicacion: {lat:null, lon: null};
    }
  ]
*/
